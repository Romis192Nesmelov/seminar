    ...
    <x-section class="white right" data-scroll-destination="about_project">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6" data-scroll-destination="academy">
                ...
                <ul>
                    <li>структурное подразделение Президентской академии</li>
                    <li>создана в 2001 году</li>
                    <li>крупнейшая в стране школа менеджмента информационных технологий</li>
                    <li>бессменным научным руководителем Школы с момента ее основания является Академик РАН Аганбегян А.Г.</li>
                </ul>
            </div>
        </div>
        <hr class="mb-0">
